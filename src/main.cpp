...
#if defined(NDEBUG)
# error "Zeal cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Zeal Signed Message:\n";
...
{
	int64_t PreMine = 500000000 * COIN;
